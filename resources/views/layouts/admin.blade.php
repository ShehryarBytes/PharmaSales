...
<head>
    ...
    <title>PharmaSales | Dashboard</title>
{!! Charts::assets() !!}
{{--{!! $map['js'] !!}--}}
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="{{route('home')}}" class="logo">
            ...
            <span class="logo-mini"><b>P</b>Sales</span>
            <!-- logo for regular state and mobile devices -->
            <span class="logo-lg"><b>Pharma</b>Sales  <small><i class="fa fa-ambulance"></i></small></span>
        </a>
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="{{ URL::to('employees/create') }}"><i class="fa fa-user-plus"></i> Add New </a>
                            </li>
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            @if(Auth::check())
                                <li><a href="{{ URL::to('customers/create') }}"><i class="fa fa-plus"></i> Add New </a>
                                </li>
                            @endif
              ...
              <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            @if(Auth::check())
                                <li><a href="{{ URL::to('companies/create') }}"><i class="fa fa-plus"></i> Add New </a>
                                </li>
                            @endif
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        ...
                        @if(!Auth::check())
                            <li><a href="{{ URL::to('orders/create') }}"><i class="fa fa-plus"></i> Add New </a></li>
                        @endif
                        {{--<li><a href="{{ URL::to('orders/update') }}"><i class="fa fa-bar-chart"></i> Filter Orders </a></li>--}}
                    </ul>
                </li>
                <li>
                    <a href="#">
                        ...
                        <ul class="treeview-menu">
                            ...
                            @if(Auth::check())
                                @if(empty(auth::user()->enterprise))
                                    <li><a href="{{ URL::to('enterprise/create') }}"><i class="fa fa-plus"></i> Add
                                            account details </a></li>@endif
                                @if(!empty(auth::user()->enterprise))
                                    <li><a href="{{ URL::to('enterprise/'. auth::user()->enterprise->id).'/edit'}}"><i
                                                    class="fa fa-edit"></i> Update Account details </a></li>
                                    <li><a href="{{ URL::to('enterprise')}}"><i class="fa fa-user-md"></i> View Profile
                                        </a></li>
                                @endif
                            @endif
                        </ul>
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2019-2020 by <a href="https://github.com/Shehryar169"> Shehryar and co. </a>.</strong>
        All rights
        reserved.
    </footer>
                ...
                <ul class="control-sidebar-menu">
                    <li>
                        <a href="javascript:void(0)">
                            ...
                            <div class="menu-info">
                                <h4 class="control-sidebar-subheading">PharmaSales Birthday</h4>

                                <p>Will be 01 on January</p>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)">
                            ...
                            <div class="menu-info">
                                <h4 class="control-sidebar-subheading">PharmaSales Updated His Profile</h4>

                                <p>New phone +92-3030706060</p>
                            </div>
                        </a>
                    </li>
                    <li>
                        <a href="javascript:void(0)">
                            ...
                            <div class="menu-info">
                                <h4 class="control-sidebar-subheading">PharmaSales mail</h4>

                                <p>khanshehryar169@gmail.com</p>
                            </div>
                        </a>
                    </li>
                </ul>
