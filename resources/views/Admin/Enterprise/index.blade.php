    ...
    <div class="container bootstrap snippet">
        <div class="row">
            <div class="col-sm-10">
                <h1>{{$data->name}}</h1></div>
            <div class="col-sm-2">
                <img title="profile image" class="img-circle img-responsive" src="{{URL::to('images/'.$data->photo->file)}}">
            </div>
        </div>
        <div class="row">
            <div class="col-sm-3">
                ...
                <ul class="list-group">
                    ...
                    <li class="list-group-item text-right"><span class="pull-left"><strong>Joined</strong></span> {{$data->created_at}}</li>
                    <li class="list-group-item text-right"><span class="pull-left"><strong>Last seen</strong></span> Yesterday</li>
                    <li class="list-group-item text-right"><span class="pull-left"><strong>Owner Name</strong></span>{{$data->owner_name}}</li>
