        ...
        <div class="row">
            <div class="col-lg-3 col-xs-6">
                ...
                <div class="small-box bg-aqua">
                    ...
                    <a href="{{ URL::to('orders') }}" class="small-box-footer">More info <i
            ...
            @if(Auth::check() || Auth::guard('employee')->user()->role->name == 'Manager')
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-green">
                        ...
                        <a href="{{ URL::to('products') }}" class="small-box-footer">More info <i
                                    class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            @endif
            ...
            @if(Auth::check() || Auth::guard('employee')->user()->role->name == 'Manager')
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-yellow">
                        ...
                        <a href="{{ URL::to('customers') }}" class="small-box-footer">More info <i
                                    class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
            @endif
            ...
            @if(Auth::check() || Auth::guard('employee')->user()->role->name == 'Manager')
                <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="small-box bg-red">
                        ...
                        <a href="{{ URL::to('companies') }}" class="small-box-footer">More info <i
                                    class="fa fa-arrow-circle-right"></i></a>
                    </div>
                </div>
        @endif
